        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a href = "<?php echo base_url();?>Web/create" data-toggle="tooltip" data-placement="bottom" title = "create"><span class = "glyphicon glyphicon-list-alt" style = "font-size: 1.2em;"></span></a>
					</li>
					<li class = "dropdown">
					...
					<li class = "dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="<?php echo base_url();?>Web/AccountSettings">Account Settings<span ></span></a>
							</li>
							<li class="divider"></li>
							<li>
