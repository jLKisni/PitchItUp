<header>
   ...
   top: 200px;">
              <img src= "<?php echo base_url();?>assets/img/Temp2.png" style = "width: 200px; height: 200px;" id="pres2" class="presentation_hover" >
               <br/>
                 <span><a href = "<?php echo base_url();?>pdf/tutorial/pdfgeneratorproduct.php?id=<?php echo $this->session->userdata('team_id');?>"  class="btn btn-danger btn-sm" id="pdf2" style="position:inherit">View As PDF</a></span>
