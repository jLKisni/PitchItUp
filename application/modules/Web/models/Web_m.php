...
function addPitchdeck(){
  ...
  $query1 = $this->db->query($sql1,array($this->session->userdata('valuepropid'),$this->session->userdata('ideaid'),$this->session->userdata('validid'),$this->session->userdata('bmcid'),$this->session->userdata('team_id')));
  ...
  if($query1->num_rows()>0){
    return true;
      ...
      $query = $this->db->query($sql,array($this->session->userdata('valuepropid'),$this->session->userdata('ideaid'),$this->session->userdata('validid'),$this->session->userdata('bmcid'),$this->session->userdata('team_id')));
