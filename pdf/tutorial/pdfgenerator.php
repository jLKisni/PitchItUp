...
$pdf->Cell(0,10,'The Market Channels  : ',0,1);
$pdf->Ln(5);
$pdf->SetFont('Times','',12);

$pdf->Cell(30,0,'- '.$bmc['channels'],0,1);
...
$pdf->Cell(30,0,'- '.$bmc['value_proposition'],0,1);
...
$pdf->Cell(30,0,'- '.$bmc['revenue_streams'],0,1);

$pdf->Ln(10);

// Competitors Analysist
$pdf->SetFont('Times','B',15);

$pdf->Cell(0,10,'Competitors Analysist : ',0,1);
$pdf->Ln(5);
$pdf->SetFont('Times','',12);

$pdf->Cell(30,0,'- '.$valueprop['substitutes'],0,1);
